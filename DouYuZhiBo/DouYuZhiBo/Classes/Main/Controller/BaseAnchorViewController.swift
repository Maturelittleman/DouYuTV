...
let kNormalItemW = (kScreenW - 3*kItemMargin) / 2  //  item宽度
let kNormalItemH = kNormalItemW * 3 / 4  //  普通Item高度
let kPrettyItemH = kNormalItemW * 4 / 3  //  颜值Item高度

fileprivate let kNormalCellID = "kNormalCellID"     //  普通CellID
fileprivate let kHeaderViewID = "kHeaderViewID"     //  组头的CellID
let kPrettyFaceCellID = "kPrettyFaceCellID"     //  颜值CellID
